...
export default function Sidebar({}: Props) {
    ...
    <div className="flex items-center grayscale gap-2 mb-4">
      ...
      {!isCollapsed && (
        <div className="flex flex-col">
          <h1 className="font-bold text-xl">LouLoans</h1>
        </div>
      )}
    </div>
  );
  ...
  return (
    <div className="relative min-w-[80px] border-r pl-6 pr-12 pb-10 pt-6">
      <SidebarHeader />
      {!mobileWidth && (
