...
export default function DepositPage() {
  ...
  const handleDeposit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        setModalMessage(`Successfully deposited $${amount}`);
        setShowModal(true);
        setAmount("");
        setSelectedUser("");
      } else {
  ...
  return (
    <div className="mx-auto max-w-xl p-6">
      <h1 className="mb-6 text-2xl font-bold">Deposit Funds</h1>
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="mx-4 w-full max-w-sm rounded-lg bg-white p-6">
            <h3 className="mb-2 text-lg font-semibold">Deposit Complete</h3>
